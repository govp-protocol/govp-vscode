...
if (packageJson.name !== 'govp-partner-workbench' || packageJson.publisher !== 'gemacode' || packageJson.version !== '0.3.1') throw new Error('MARKETPLACE_ID_OR_VERSION_INVALID');
...
for (const required of [
  ...
  'package.json', 'Makefile', 'mcp_govp_implemen', 'pendiente de L1',
