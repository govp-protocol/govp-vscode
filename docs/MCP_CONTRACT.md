...
Herramientas de implantación: `get_implementation`, `generate_specification`, `request_approval`, `list_bundle_artifacts`, `get_bundle_artifact` y `validate_source_mapping`.
